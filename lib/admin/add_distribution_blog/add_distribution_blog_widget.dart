...
import 'add_distribution_blog_model.dart';
export 'add_distribution_blog_model.dart';

class AddDistributionBlogWidget extends StatefulWidget {
  const AddDistributionBlogWidget({super.key});

  @override
  State<AddDistributionBlogWidget> createState() =>
      _AddDistributionBlogWidgetState();
}

class _AddDistributionBlogWidgetState extends State<AddDistributionBlogWidget> {
  late AddDistributionBlogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDistributionBlogModel());
    ...
    _model.dollarPriceTextController ??= TextEditingController();
    _model.dollarPriceFocusNode ??= FocusNode();
                                  ...
                                  image: DecorationImage(
                                    ...
                                    image: Image.network(
                                      valueOrDefault<String>(
                                        ...
                                        'https://firebasestorage.googleapis.com/v0/b/push-app-qvknd4.appspot.com/o/projectAssets%2FimageUploadHolder.png?alt=media&token=3776cd92-050f-4869-a83e-b171b2564584',
                                      ),
                                    ).image,
                                  ),
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 12.0, 16.0, 0.0),
                        child: TextFormField(
                          controller: _model.dollarPriceTextController,
                          focusNode: _model.dollarPriceFocusNode,
                          autofocus: false,
                          textInputAction: TextInputAction.next,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Dollar Price',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelLarge
                                .override(
                                  font: GoogleFonts.spaceGrotesk(
                          ...
                          keyboardType: TextInputType.number,
                          validator: _model.dollarPriceTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(

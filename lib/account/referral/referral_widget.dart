...
class _ReferralWidgetState extends State<ReferralWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.refData = await queryReferralsRecordOnce(
        queryBuilder: (referralsRecord) => referralsRecord.where(
          'referred_id',
          isEqualTo: valueOrDefault(currentUserDocument?.refCode, ''),
        ),
      );
      FFAppState().earningTotalAmount = valueOrDefault<double>(
        functions.sumFirebaseQuery(
            _model.refData!.map((e) => e.earnings).toList().toList()),
        0.0,
      );
      safeSetState(() {});
    });
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/push_referral.png',
                                            width: 126.0,
                                            height: 93.0,
                                            fit: BoxFit.cover,
                                          ),
                              ...
                              Builder(
                                builder: (context) => Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await Share.share(
                                        'Download Push and Signup using my refferal code: ${valueOrDefault(currentUserDocument?.refCode, '') != '' ? valueOrDefault(currentUserDocument?.refCode, '') : 'NULL'}',
                                        sharePositionOrigin:

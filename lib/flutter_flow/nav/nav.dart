...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PushWidget.routeName,
          path: PushWidget.routePath,
          builder: (context, params) => PushWidget(),
        ),
        FFRoute(
          name: PushDetailsWidget.routeName,
          path: PushDetailsWidget.routePath,
          builder: (context, params) => PushDetailsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DistributionBlogWidget.routeName,
          path: DistributionBlogWidget.routePath,
          asyncParams: {
            'searchBlogMediaPage': getDoc(['media'], MediaRecord.fromSnapshot),
          },
          builder: (context, params) => DistributionBlogWidget(
            searchBlogMediaPage: params.getParam(
              'searchBlogMediaPage',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: ContentWidget.routeName,
          path: ContentWidget.routePath,
        ...
        FFRoute(
          name: AdminDistributionListWidget.routeName,
          path: AdminDistributionListWidget.routePath,
          builder: (context, params) => AdminDistributionListWidget(),
        ),
        FFRoute(
          name: FundingGatewayWidget.routeName,
          path: FundingGatewayWidget.routePath,
          builder: (context, params) => FundingGatewayWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: MediaSearchPageWidget.routeName,
          path: MediaSearchPageWidget.routePath,
          asyncParams: {
            'searchBlogMediaPage': getDoc(['media'], MediaRecord.fromSnapshot),
          },
          builder: (context, params) => MediaSearchPageWidget(
            searchBlogMediaPage: params.getParam(
              'searchBlogMediaPage',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: PushOrdersWidget.routeName,
          path: PushOrdersWidget.routePath,
          builder: (context, params) => PushOrdersWidget(),
        ),
        FFRoute(
          name: PushOrderDetailsWidget.routeName,
          path: PushOrderDetailsWidget.routePath,
          requireAuth: true,
          asyncParams: {
            'pushOrderDoc': getDoc(['push'], PushRecord.fromSnapshot),
          },
          builder: (context, params) => PushOrderDetailsWidget(
            pushOrderDoc: params.getParam(
              'pushOrderDoc',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: MediaSearchPageCopyWidget.routeName,
          path: MediaSearchPageCopyWidget.routePath,
          asyncParams: {
            'searchBlogMediaPage': getDoc(['media'], MediaRecord.fromSnapshot),
          },
          builder: (context, params) => MediaSearchPageCopyWidget(
            searchBlogMediaPage: params.getParam(
              'searchBlogMediaPage',
              ParamType.Document,
            ),

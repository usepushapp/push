                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 0.0, 12.0),
                                child: Text(
                                  'We would send you an email with a link to reset your password. Please enter the email associated with your account below',
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    '_model.resetEmailTextController',
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 16.0, 8.0),
                                    suffixIcon: _model.resetEmailTextController!
                                            .text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.resetEmailTextController
                                  ...
                                  validator: _model
                                      .resetEmailTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ],
